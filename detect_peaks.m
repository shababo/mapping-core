...
for i = 1:size(traces,1)
    ...
    [~, event_times, w, p] = findpeaks(traces(i,:),'MinPeakHeight',max(threshold_min,threshold*std(traces(i,start_ind:end))),'MinPeakDistance',min_window,'MinPeakProminence',27,'MaxPeakWidth',60);
    w
    p
