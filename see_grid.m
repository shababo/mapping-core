function [map_ch1,map_ch2,corr_ch1,corr_ch2] = see_grid(data,trials,map_index,do_plot,num_stims)
...
%         figure; plot(stim)
        stim_starts(1:length(stim_starts)-num_stims) = [];
    end
%     
...
%     figure;compare_trace_stack_grid({map_ch1,map_ch2},Inf,1,[],0,{'raw','detected events'})
    ...
    figure;compare_trace_stack_grid_overlap({map_ch1,map_ch2},3,1,[],0,{'L4','L5'},1)
